...
class CodeTest(unittest.TestCase):
    ...
    @unittest.skip("code type constructor not supported; gopy code objects are compiler-only")
    ...
    @unittest.skip("constructor part requires code type constructor; replace part passes via test_replace")
    ...
    @unittest.skip("gopy VM does not raise SystemError for unknown opcodes; returns AttributeError")
    ...
    @unittest.skip("requires subprocess with -X no_debug_ranges CPython flag")
    ...
    @unittest.skip("requires subprocess with PYTHONNODEBUGRANGES env var")
...
class CodeWeakRefTest(unittest.TestCase):
    ...
    @unittest.skip("gopy GC does not finalize code objects promptly enough for weakref liveness check")
    def test_basic(self):
...
class CodeLocationTest(unittest.TestCase):
    ...
    @unittest.skip("co_branches() not implemented")
