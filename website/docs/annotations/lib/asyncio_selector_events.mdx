...
<Map
  entries={[
    { name: "_SelectorEventLoop", kind: "class" },
    { name: "_SelectorEventLoop._process_events", kind: "method" },
    { name: "_SelectorEventLoop._ensure_fd_no_transport", kind: "method" },
    { name: "BaseSelectorEventLoop", kind: "class" },
    { name: "_SelectorTransport", kind: "class" },
    { name: "_SelectorSocketTransport", kind: "class" },
    { name: "_SelectorDatagramTransport", kind: "class" },
    { name: "_SelectorSocketTransport._read_ready", kind: "method" },
    { name: "_SelectorSocketTransport._write_ready", kind: "method" },
  ]}
/>
