...
| `Objects/boolobject.c` | 227 | (pending) | bool |
| `Objects/bytearrayobject.c` | 3070 | (pending) | bytearray |
...
| `Objects/complexobject.c` | 1422 | (pending) | complex |
...
| `Objects/rangeobject.c` | 1317 | (pending) | range |
