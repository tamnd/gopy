---
title: utypes
description: gopy's types subsystem. Mirrors CPython's design.
---

# utypes

This page describes how gopy implements **types**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/types`](../cpython/types).
...
* CPython companion: [cpython/types](../cpython/types).
