---
title: uobjects
description: gopy's objects subsystem. Mirrors CPython's design.
---

# uobjects

This page describes how gopy implements **objects**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/objects`](../cpython/objects).
...
* CPython companion: [cpython/objects](../cpython/objects).
