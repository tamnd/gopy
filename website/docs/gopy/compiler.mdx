---
title: ucompiler
description: gopy's compiler subsystem. Mirrors CPython's design.
---

# ucompiler

This page describes how gopy implements **compiler**. The design follows
...
* CPython companion: [cpython/compiler](../cpython/compiler).
