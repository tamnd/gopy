---
title: ugc
description: gopy's gc subsystem. Mirrors CPython's design.
---

# ugc

This page describes how gopy implements **gc**. The design follows
...
* CPython companion: [cpython/gc](../cpython/gc).
