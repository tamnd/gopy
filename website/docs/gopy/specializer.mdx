---
title: uspecializer
description: gopy's specializer subsystem. Mirrors CPython's design.
---

# uspecializer

This page describes how gopy implements **specializer**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/specializer`](../cpython/specializer).
...
* CPython companion: [cpython/specializer](../cpython/specializer).
