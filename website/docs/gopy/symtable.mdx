---
title: usymtable
description: gopy's symtable subsystem. Mirrors CPython's design.
---

# usymtable

This page describes how gopy implements **symtable**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/symtable`](../cpython/symtable).
...
* CPython companion: [cpython/symtable](../cpython/symtable).
