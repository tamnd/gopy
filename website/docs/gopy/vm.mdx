---
title: uvm
description: gopy's vm subsystem. Mirrors CPython's design.
---

# uvm

This page describes how gopy implements **vm**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/vm`](../cpython/vm).
...
* CPython companion: [cpython/vm](../cpython/vm).
