---
title: uflowgraph
description: gopy's flowgraph subsystem. Mirrors CPython's design.
---

# uflowgraph

This page describes how gopy implements **flowgraph**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/flowgraph`](../cpython/flowgraph).
...
* CPython companion: [cpython/flowgraph](../cpython/flowgraph).
