---
title: uassembler
description: gopy's assembler subsystem. Mirrors CPython's design.
---

# uassembler

This page describes how gopy implements **assembler**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/assembler`](../cpython/assembler).
...
* CPython companion: [cpython/assembler](../cpython/assembler).
