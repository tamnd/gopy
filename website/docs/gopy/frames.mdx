---
title: uframes
description: gopy's frames subsystem. Mirrors CPython's design.
---

# uframes

This page describes how gopy implements **frames**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/frames`](../cpython/frames).
...
* CPython companion: [cpython/frames](../cpython/frames).
