---
title: umonitor
description: gopy's monitor subsystem. Mirrors CPython's design.
---

# umonitor

This page describes how gopy implements **monitor**. The design follows
CPython page-for-page. For the upstream reference see
[`cpython/monitor`](../cpython/monitor).
...
* CPython companion: [cpython/monitor](../cpython/monitor).
