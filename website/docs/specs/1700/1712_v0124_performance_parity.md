...
| P4. PyUnicode kind tags         | `Objects/unicodeobject.c` | `objects/unicode_kind.go` | 2x         | WIP (P4.2 + P4.3 + P4.5 ASCII fast paths + latin1 singleton cache shipped, 25x faster ASCII find / 0 allocs / shared one-char strings; P4.1 pre-encoded UCS2/UCS4 storage, P4.4 writer still open) | this PR |
