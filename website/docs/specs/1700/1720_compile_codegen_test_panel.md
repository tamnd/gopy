...
| test_codecmaps_cn | deferred | CJK codec maps |
| test_codecmaps_hk | deferred | CJK codec maps |
| test_codecmaps_jp | deferred | CJK codec maps |
| test_codecmaps_kr | deferred | CJK codec maps |
| test_codecmaps_tw | deferred | CJK codec maps |
| test_charmapcodec | deferred | charmap codec not shipped |
| test_multibytecodec | deferred | multibyte codec base class |
