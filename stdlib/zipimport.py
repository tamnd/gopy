...
# gopy resolves imports Go-side and never freezes the bootstrap modules,
# so the frozen _frozen_importlib / _frozen_importlib_external names are
# unavailable. The vendored importlib._bootstrap and
# importlib._bootstrap_external are the same source, so import them
# directly.
from importlib import _bootstrap_external
from importlib._bootstrap_external import _unpack_uint16, _unpack_uint32, _unpack_uint64
