...
// seqIsUpdating reports whether the sequence number is odd, which
// indicates an in-progress write.
//
// CPython: Python/lock.c:L543 _PySeqLock_LockWrite (adapted from)
