...
func (s *stubFrame) FrameSetLocalsPlusItem(int, objects.Object) {}
func (s *stubFrame) FrameNumStack() int                         { return 0 }
func (s *stubFrame) FrameStackItem(int) objects.Object          { return nil }
