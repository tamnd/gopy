// Phase 4 of spec 1715: stackdepth + optimize_load_fast + helpers,
// ported onto the cfgBuilder graph. The flat-sequence stackdepth lives
// in flowgraph_stackdepth.go and is kept until phase 6 retires the
// flat shim; this file is the CFG-substrate port.
//
